...
**Assessment:** discrete physical observation threshold admission exists, but general threshold/coalescing for gradual physical/environmental values remains open.
...
- [ ] Add or plan an integrated timing scenario similar to the proposed 20 m walk / Gerald / falling-palm trace. **The component boundaries are now individually covered through PR #31, including concrete escape execution and representative due-scheduled gradual work. What remains is the single integrated timing scenario plus Gerald semantics and gradual semantic coalescing.**
...
**Consumed by:** PR #16 (partial), PR #17 (partial), PR #18 (partial), PR #19 (partial), PR #21 (partial), PR #23 (partial), PR #25 (partial), PR #27 (partial), PR #29 (partial), PR #31 (partial)  
**Latest validated consumption:** PR #31 — strict runner `49 PASS / 49 TOTAL` under Godot 4.7.1; real-engine spatial fixture remains part of the strict suite  
**Completion date:** _pending remaining checklist items_  
**Rejected/deferred recommendations and rationale:** stable sequence/physics timestamp metadata for `PhysicalObservation` remains deferred until a representative same-step accident demonstrates that insertion ordering is insufficient. General gradual physical/environmental coalescing is not claimed by PRs #23/#25/#31 because discrete observation thresholds and due scheduling do not themselves define semantic coalescing. Sparse maintenance due work is deferred until representative behavior requires it; PR #31 establishes the shared mechanism without inventing maintenance work. The full 20 m / Gerald / falling-palm regression remains deferred until gradual semantic coalescing and representative scenario composition are ready; concrete defensive motion redirection and representative drive/process due scheduling are now separately validated.
