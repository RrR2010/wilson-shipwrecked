...
This is the operational model/content backlog for persistent composed projects and structures. See [`README.md`](README.md) for ownership, status and column semantics.
